...
import com.example.wqh.fragment.TabFirstFragment;
import com.example.wqh.fragment.TabSecondFragment;
import com.example.wqh.fragment.TabThirdFragment;
import com.example.wqh.util.DateUtil;
import com.example.wqh.util.MenuUtil;
...
public class ShoppingActivity extends AppCompatActivity {
    ...
    private void initSearchView(Menu menu) {
        ...
        // 创建搜索结果页面的组件名称对象
        ComponentName cn = new ComponentName(this, com.example.wqh.SearchResultActvity.class);
