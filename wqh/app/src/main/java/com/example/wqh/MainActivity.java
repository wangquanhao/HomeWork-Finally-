...
import com.example.wqh.bean.UserInfo;
import com.example.wqh.database.UserDBHelper;
import com.example.wqh.util.DateUtil;
import com.example.wqh.util.ViewUtil;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮s
            ...
            if (rb_password.isChecked()) { // 选择了密码方式校验，此时要跳到找回密码页面
                Intent intent = new Intent(this, com.example.wqh.LoginForgetActivity.class);
                // 携带手机号码跳转到找回密码页面
