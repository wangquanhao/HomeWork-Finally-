...
import com.example.wqh003.bean.UserInfo;
import com.example.wqh003.database.UserDBHelper;
import com.example.wqh003.util.DateUtil;
import com.example.wqh003.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private Switch sw_ios;
    private TextView text_jzmm;// 声明一个复选框对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_jzmm=findViewById(R.id.text_jzmm);
        // 给rg_login设置单选监听器
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990053王泉皓"};
